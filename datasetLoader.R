datasetLoader <- function (datasetName)
{
  ...
  switch(datasetName,
         ...
         australian={
          dataLoad <- read.csv(file="./australian.data",header=FALSE,sep=" ")
         ...
         #2. balance dataset
         balance={ 
           dataLoad <-read.csv(file="./balance-scale.data",header=FALSE,sep=",")
         ...
         dermatology ={
           dataLoad <-read.csv(file="./dermatology.data",header=FALSE,sep=",")
         ...
         #5. heart dataset 
         heart={
           dataLoad <-read.csv(file="./processed.cleveland.data",header=FALSE,sep=",")
         ...
         #8. liver dataset
         liver={
           dataLoad <-read.csv(file="./bupa.data",header=FALSE,sep=",")
         ...
         #11. waveform dataset
         waveform={
           dataLoad <-read.csv(file="./waveform-+noise.data",header=FALSE,sep=",")
         ...
         #12. yeast dataset
         yeast ={
           dataLoad <-read.csv(file="./yeast.data",header=FALSE,sep=" ")
